...
<template>
  <div>
    ...
    <p>
      You must then also enable port forwarding on your router to the port that OBS runs on (default
      is 4455). Please follow your router's instructions on how to do this. The URL should look like
