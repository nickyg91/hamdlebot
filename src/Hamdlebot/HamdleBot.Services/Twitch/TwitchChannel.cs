...
public class TwitchChannel
{
    ...
    private void SetupObsSocketEvents()
    {
        ...
        _obsWebSocketHandler.OnFault += async () => { await SendObsConnectionPing(ObsConnectionStatusType.Errored); };
    ...
    private async Task AuthenticateToIrc()
    {
